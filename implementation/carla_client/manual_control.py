...
class ManualControlWindow(object):
    def __init__(self, carla_world, map, vehicle, camera, client):
        ...
        pygame.display.flip()
        self.controller = KeyboardControl(self, self.vehicle)
    ...
    def tick(self, clock):
        vehicle_control = self.controller.parse_events(self, clock)
...
class KeyboardControl(object):
    ...
    def parse_events(self, world: ManualControlWindow, clock: pygame.time.Clock):
        if isinstance(self._control, carla.VehicleControl):
            current_lights = self._lights

        if isinstance(self._control, carla.VehicleControl):
            manual_control_available = self._parse_vehicle_keys(pygame.key.get_pressed(), clock.get_time())
